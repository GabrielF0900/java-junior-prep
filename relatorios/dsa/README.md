...
- [Semana 1 — HashMap/HashSet e Big O](#semana-1)
- [Semana 4 — Reserva de Stack/Queue](#semana-4)
...
Contains Duplicate tem dois resultados manuais informados por Gabriel e quatro casos pendentes. Ainda não há prints no repositório nem testes automatizados específicos dos desafios.

## Semana 4

| Desafio | Estrutura principal | Status | Documentação | Código |
| --- | --- | --- | --- | --- |
| Valid Parentheses | Não implementada; tema de Stack/Queue no calendário | Não iniciado: somente package e TODO, sem classe | Ainda não existe | [ValidParentheses.java](../../src/main/java/br/com/gabrielfalcao/prep/dsa/semana4/ValidParentheses.java) |

A reserva não autoriza iniciar o tópico nem representa uma solução.
